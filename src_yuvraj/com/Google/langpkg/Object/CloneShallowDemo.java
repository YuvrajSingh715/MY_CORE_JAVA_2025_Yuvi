...
public class CloneShallowDemo implements Cloneable {

	String s1;
	String s2;

	public CloneShallowDemo(String s1, String s2) {
		this.s1 = s1;
		this.s2 = s2;
	}
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		CloneShallowDemo cm1 = new CloneShallowDemo("Yegritte", "JonSnow"); // Object creation
		
		CloneShallowDemo cm2 = cm1; // shallow cloning
